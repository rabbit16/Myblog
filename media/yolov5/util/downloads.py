...
def attempt_download(file, repo='ultralytics/yolov5'):  # from util.downloads import *; attempt_download()
...
def gdrive_download(id='16TiPfZj7htmTyhntwcZyEEAejOUxuT6m', file='tmp.zip'):
    # Downloads a file from Google Drive. from yolov5.util.downloads import *; gdrive_download()
    t = time.time()
    file = Path(file)
...
# Google util: https://cloud.google.com/storage/docs/reference/libraries ----------------------------------------------
#
#
