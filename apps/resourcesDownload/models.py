...
class Resource(ModelBase):
    ...
    downloadTitle = models.CharField(verbose_name="下载标题", help_text="下载标题", max_length=400, default='')
    ...
    img_url = models.CharField(verbose_name='图片路径', help_text='图片路径', default="../../static/logo/jhl_logo.png", max_length=100)
