...
$(document).ready(function(){
    ...
    function snowCanvas() {
        ...
        snowcanvas.setAttribute("style", "position:absolute; top: 0; right: 0; z-index: 1; pointer-events: none;float:left");
    ...
    function snowCanvas() {
        ...
        {
            snowcanvas.height = $(document.body).height()-1000;
            console.log('Pc', snowcanvas.height)
        }
        else {
            snowcanvas.height = $(document.body).height();
            console.log('Phone', snowcanvas.height)
        }
